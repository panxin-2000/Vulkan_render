...
void Engine::update_global_pbr_parameter(
    ...
    if (size > 0) {
        ...
        auto gltf_shader_data = shader_manager_.get_gltf_shader_data();
        VK_update_parameter(gltf_shader_data->global_sets_bindings, update_global_descriptor_sets,
