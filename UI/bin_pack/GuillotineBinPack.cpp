...
namespace rbp {
    ...
    */
    ...
    int GuillotineBinPack::ScoreByHeuristic(int width, int height, const Rect &freeRect,
    ...
    Rect GuillotineBinPack::FindPositionForNewNode(int width, int height, FreeRectChoiceHeuristic rectChoice,
                                                   int *nodeIndex) {
        Rect bestNode;
    ...
    void GuillotineBinPack::SplitFreeRectByHeuristic(const Rect &freeRect, const Rect &placedRect,
    ...
    void GuillotineBinPack::MergeFreeList() {
        ...
        for (size_t i = 0; i < freeRectangles.size(); ++i)
            for (size_t j = i + 1; j < freeRectangles.size(); ++j) {
                ...
                } else if (freeRectangles[i].height == freeRectangles[j].height && freeRectangles[i].y == freeRectangles
                           [j].y) {
