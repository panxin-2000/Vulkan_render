...
namespace sh {
    namespace {
        ...
        //                  0.0, 1.0);
        //   }, 10000000);
        const std::vector<double> cosine_lobe = {
            0.886227, 0.0, 1.02333, 0.0, 0.0, 0.0,
            0.495416, 0.0, 0.0
        };
        ...
        template<>
        Eigen::Array3f Zero() { return Eigen::Array3f::Zero(); }
...
# define CHECK(condition, message) do {} while(false)
        ...
        double Factorial(int x) {
            static const double factorial_cache[kCacheSize] = {
        ...
        double DoubleFactorial(int x) {
            static const double dbl_factorial_cache[kCacheSize] = {
                1, 1, 2, 3, 8, 15, 48, 105,
    ...
    template<>
    void Rotation::Apply<Eigen::Array3f>(
