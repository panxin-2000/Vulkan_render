...
#define EXPECT_TUPLE2_NEAR(expected, actual, tolerance) \
  { \
    ...
    TEST(SphericalHarmonicsTest, ProjectEnvironment) {
        ...
        // passed into Project()
        const std::vector<double> c_red = {
            -1.028, 0.779, -0.275, 0.601, -0.256,
            1.891, -1.658, -0.370, -0.772
        };
        const std::vector<double> c_green = {
            -0.591, -0.713, 0.191, 1.206, -0.587,
            -0.051, 1.543, -0.818, 1.482
        };
        const std::vector<double> c_blue = {
    ...
    TEST(SphericalHarmonicsTest, EvalSHSumArray3f) {
        const std::vector<double> coeffs_0 = {
            -1.119, 0.559, 0.433, -0.680, -1.815,
            -0.915, 1.345, 1.572, -0.622
        };
        const std::vector<double> coeffs_1 = {
            -0.591, -0.713, 0.191, 1.206, -0.587,
            -0.051, 1.543, -0.818, 1.482
        };
        const std::vector<double> coeffs_2 = {
            -1.119, 0.559, 0.433, -0.680, -1.815,
            -0.915, 1.345, 1.572, -0.622
        };
